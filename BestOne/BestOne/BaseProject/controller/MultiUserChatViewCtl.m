...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([sender isEqualToString:@"me"]) {
        ...
        [cell.messageContentView setFrame:CGRectMake(320-size.width - padding, padding*2, size.width+20, size.height)];
        ...
        [cell.messageContentView setFrame:CGRectMake(padding, padding*2, size.width+20, size.height)];
